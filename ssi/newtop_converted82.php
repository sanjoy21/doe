...
<body id="p-<?php if( ($session_iscorp) == 1 ) { ?>corporate<?php } else if( ($session_iscorp) == 2 ) { ?><?} else if( ($session_iscorp) == 4 ) { ?>dfta<?php } else if( ($session_iscorp) == 3 ) { ?>training<?php } else { ?>doe<?php } ?>">
