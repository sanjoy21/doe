...
<table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="700">
	...
	<tr>
		...
		<strong>Please select the schedule would you like to edit:</strong><p>
		
		
		<table cellpadding="5" cellspacing="1" border="0">
			<tr>
<form method='post'>	<td valign="top">
				<select name="schedule" style="font-size: 10px;  font-family: verdana;">
		<option value="reg">Emergency Skills Regular Class Schedule</option>
		<option value="dd">Emergnecy Skills Defensive Driving</option>
	<? $result = mysql_query( "select name, shortcut from cities order by name" );
while( $row = mysql_fetch_array( $result ) ) { ?>
<option value="<?=$row["shortcut"]?>">Emergency Skill/TSI <?=$row["name"]?></option>
<? } ?>
				</select>
</td>	
				<td><input type="submit" value="GO" style="font-size: 10px;  font-family: verdana;"></td>			
			</tr>
<tR><td><span class="copy">	 <a href="http://doe.emergencyskills.com/cms/editcities.php">      <u>Edit Cities (TSI Schedules)</u></a>
</span></td></tr>
<tR><td><span class="copy">	 <a href="http://doe.emergencyskills.com/cms/mainclasses.php">      <u>Edit Classes (Regular ESI Training Schedule)</u></a>
</span></td></tr>
		</table>
