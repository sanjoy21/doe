...
if( $shortcut )
{
mysql_query( "insert into cities ( name, shortcut ) values ( '$name', '$shortcut' )" );
}
if( $del )
{
mysql_query( "delete from cities where shortcut = '$del'" );
}
...
<table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="700">
	...
	<tr>
		...
		<table cellpadding="5" cellspacing="1" border="0">
			<tr>
<form method='post'>	<td valign="top">
<table cellpadding="3" width="400" border="0"><tr>
<td width="100"><span class="copy"><strong>City Name</strong></span></td>
<td width="100" align="center"><span class="copy"><strong>Shortcut</strong></span></td>
<td width="100" align="center">&nbsp;</td>
<td width="100" align="center">&nbsp;</td>
</tr>
<? while( $row = mysql_fetch_array( $result ) ) { ?>
<tr><td><span class="copy"><?=$row["name"]?></span></td><td align="center"><span class="copy"><?=$row["shortcut"]?></span></td><td align="center"><span class="copy"><a href='editregions.php?id=<?=$row["shortcut"]?>'>Regions</a></span></td><td align="center"><span class="copy"><a href='editcities.php?del=<?=$row["shortcut"]?>'>Delete</a></span></td></tr>
<? } ?>
</td>

				<td><br><span class="copy">
New City Name: <br><input type='text' name='name'><br><br>
New Shortcut: <br><input type='text' name='shortcut'><br><br>
