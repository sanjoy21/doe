...
$result = mysql_query("select * from cms where type = 'dd'" );
?>
...
<table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="700">
	...
	<tr>
		...
		<strong>You are editing the Emergency Skills Defensive Driving Schedule.</strong><p>
						...
						<table border="1" cellpadding="3" cellspacing="0" width="465" bgcolor="#ffffff">
							...
							<tr>
								<td valign="top" width="113">
									...
									Thursday<br>
									Sept. 25, 2004<p>
									<em>(Must attend both sessions)</em>
									</span></div>									
								</td>							
								<td valign="top" width="113">
									<div align="center"><span class="copy">
