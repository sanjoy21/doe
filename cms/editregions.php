...
if( $id )
{
session_unregister( "session_region" );
$session_region = $id;
session_register( "session_region" );
}

if( $addregion )
{
mysql_query( "insert into regions ( name, city ) values ( '$addregion', '$session_region' )" );
}
if( $del )
{
mysql_query( "delete from regions where name = '$del' and city = '$session_region'" );
}

$result = mysql_query( "select * from regions where city = '$session_region' order by name " );
...
<table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="700">
	...
	<tr>
		...
		<table cellpadding="5" cellspacing="1" border="0" width="465">
			<tr>
				<td valign="top" align="right" bgcolor="#ffffff" colspan="2"><span class="small"><strong><a href="http://doe.emergencyskills.com/adminmain.jsp">&laquo; Back to Admin Main</a><br>
<a href="http://doe.emergencyskills.com/cms/editcities.php">&laquo; Back to Edit Cities</a></strong></span></td>				
...
You are editing regions for <?=$session_region?><br><br>
<table cellpadding="3" border="0">
	<tr>
		<td colspan="2"><span class="copy"><strong>Region Names</strong></span></td>
	</tr>
<? while( $row = mysql_fetch_array( $result ) ) { ?>
<tr><td><span class="copy"><span class="copy"><?=$row["name"]?></span></td>
	<td><span class="copy"><span class="copy"><a href='editregions.php?del=<?=$row["name"]?>'>Delete</a></span></td></tr>
<? } ?>
</span></td>

				<td><br><span class="copy">
New Region Name: <br><input type='text' name='addregion'><br><br>
<input type="submit" value="Add New" style="font-size: 10px;  font-family: verdana;"></span></td>			
			</tr>
		</table>
