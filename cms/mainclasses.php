...
<a href='editclasses.php?id=reg'>Edit Class Types for Regular Class Schedule</a><br>
<!--<a href='editclasses.php?id=dd'>Edit Class Types for Defensive Driving</a><br>-->
<!--<? $result = mysql_query( "select * from cities order by name" );
while( $row = mysql_fetch_array( $result ) ) { ?>
<a href='editclasses.php?id=<?=$row["shortcut"]?>'>Edit Class Types for <?=$row["name"]?></a><br>
<? } ?>
</span>--></td>
			</tr>
		</table>
