...
function togglefield(theele, enabled) {
    theele.disabled = (!enabled);
}

// }}}
// {{{ getCalendar()

function getCalendar(in_dateField, in_dateDay, in_dateYear) 
{
    ...
    if( isdefined( in_dateDay ) )
    {
        calendarMonth = in_dateField;
        calendarDay = in_dateDay;
        calendarYear = in_dateYear;
    }
    else
    {
