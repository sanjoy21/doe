...
if($companyid > 0) {
    ...
    $safe_iscorp = isset($session_iscorp) ? intval($session_iscorp) : 0;
...
<?php if($count == 0): ?>
    <br><span class='copy' style='color:red'>No schools found matching your criteria. Please try a different search.</span>
<?php endif; ?>
