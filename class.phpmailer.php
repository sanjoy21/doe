...
class PHPMailer
{
    ...
    */
    ...
    function EncodeQP ($str) {
        ...
        // Replace every high ascii, control and = characters - FIXED for PHP 8.2
        $encoded = preg_replace_callback('/([\000-\010\013\014\016-\037\075\177-\377])/',
                  function($matches) {
                      return '=' . sprintf('%02X', ord($matches[1]));
                  }, $encoded);
        
        // Replace every spaces and tabs when it's the last character on a line - FIXED for PHP 8.2
        $encoded = preg_replace_callback("/([\011\040])".$this->LE."/",
                  function($matches) use ($encoded) {
    ...
    function EncodeQ ($str, $position = "text") {
        ...
        switch (strtolower($position)) {
          case "phrase":
            // FIXED for PHP 8.2 - replaced /e modifier with preg_replace_callback
          ...
          case "text":
          default:
            // Replace every high ascii, control =, ? and _ characters - FIXED for PHP 8.2
...
// because of spam
    ...
    function ServerVar($varName) {
        // Remove global variable usage for PHP 8.2 compatibility
