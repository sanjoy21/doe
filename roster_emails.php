...
<?php $classname = $mynames[$crow["code"]]; ?> 
...
<?php if ($crow["iscorp"]) { ?>   </tr>   
   <tr style="height: 14px;">
<?php } ?>
    <td valign="middle"><strong>Session Date &amp; Time:</strong></td>
...
<br>
          ...
          <tr style="background-color: #ededed; height: 20px;">
              <td valign="middle" class="style2" style="width: 10%;"><strong>Last Name</strong></td>
              <td valign="middle" class="style2" style="width: 10%;"><strong>First Name</strong></td>
              <td valign="middle" class="style2" style="width: 15%;"><strong>Email</strong></td>
              <td valign="middle" class="style2" style="width: 10%;"><strong>Sign In</strong></td>
...
for ($i = 1; $i <= $max; $i++) {
    ...
    $ts = isset($attendees[$i]["timeslot"]) ? $attendees[$i]["timeslot"] : "";
    $arow = array();
    $mycomrow = array();
    if ($att) {
...
?>
            <tr style="height: 25px;">
                 ...
                 if (isset($arow["responderid"]) && $arow["responderid"]) {
                     echo "$arow[lastname]<td valign=\"middle\" class=\"copy\">$arow[firstname]";
                 } else {
                     echo "&nbsp;</td><td>";
                 }
     echo "&nbsp;</td>";
     echo '<td valign="middle" class="copy">' . (isset($arow["email"]) ? $arow["email"] : "") . '&nbsp;<div style="text-align: right">' . ($ts ? "Timeslot: " . $ts : "") . '</div></td>';
     echo "<td>&nbsp;</td>";
     echo "<td>&nbsp;</td>";
     ?>
            </tr>
